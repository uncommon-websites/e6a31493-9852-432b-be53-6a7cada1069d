...
<svelte:head>
	...
	<meta name="description" content="Learn about Sentra's mission to build the first AI teammate that improves organizational alignment through autonomous intelligence." />
</svelte:head>
