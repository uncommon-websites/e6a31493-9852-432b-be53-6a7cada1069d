	...
	<div class="flex flex-1 items-center justify-center">
		<div class="relative">
			...
			<div class="relative flex items-center justify-center">
				<div
					class="relative h-16 w-16 bg-white border-2 border-blue-200 shadow-lg"
					style="border-radius: var(--radius-lg);"
				>
					<!-- Brain icon -->
					<div class="absolute inset-0 flex items-center justify-center">
						<IconBrain class="h-8 w-8 text-blue-600 animate-pulse" style="animation-duration: 3s;" />
					</div>
				</div>
			</div>
			...
			<div class="absolute -top-12 left-1/2 -translate-x-1/2">
				<div class="flex flex-col items-center space-y-2">
					...
					/>
					<div class="relative w-px h-6 {isActive(0) ? 'bg-blue-500' : 'bg-gray-300'}">
						{#if isActive(0)}
			...
			<!-- Bottom Right: Notion -->
			<div class="absolute -bottom-8 -right-16" style="transform: translate(-50%, -50%) rotate(-45deg);">
				<div class="flex items-center space-x-2" style="transform: rotate(45deg);">
			...
			<div class="absolute -bottom-12 left-1/2 -translate-x-1/2">
				<div class="flex flex-col items-center space-y-2">
					<div class="relative w-px h-6 {isActive(4) ? 'bg-blue-500' : 'bg-gray-300'}">
						{#if isActive(4)}
							<div class="absolute inset-0 bg-blue-500 animate-pulse"></div>
						{/if}
					</div>
			...
			<!-- Bottom Left: Docs -->
			<div class="absolute -bottom-8 -left-16" style="transform: translate(50%, -50%) rotate(45deg);">
				<div class="flex items-center space-x-2" style="transform: rotate(-45deg);">
					<svelte:component 
